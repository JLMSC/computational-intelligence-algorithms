...
- Implement single-layer neural models from scratch
- Train models using iterative optimization procedures
...
- ADALINE performance depends on appropriate normalization of inputs
- No support for multi-class classification
- No vectorized optimization (loop-based implementation)
- Train/test split is randomized each epoch, which may introduce variance in evaluation
