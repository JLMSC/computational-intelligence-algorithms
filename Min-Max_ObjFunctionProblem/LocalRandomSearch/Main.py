...
def LocalRandomSearch(f, sigma: float, x1_bounds: Tuple[float, float], x2_bounds: Tuple[float, float], max_it: int, dropout: int):
    """Applies Local Random Search in 'f' problem.
